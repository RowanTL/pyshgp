{
  ...
  outputs =
    ...
    in
    {
      ...
      packages.x86_64-linux.default = pythonSet.mkVirtualEnv "pysh-env" workspace.deps.default;

      # Make hello runnable with `nix run`
      # I don't want it runnable like this so comment it out for now.
      # apps.x86_64-linux = {
      #   default = {
      #     type = "app";
