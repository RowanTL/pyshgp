...
from pyshgp.push.interpreter import MemoryInterpreter

sliding_window_size: int = 50

btc_usd_data: pd.DataFrame = pd.read_csv(
    "/home/user/Documents/CS6401/pyshgp/examples/stocks/btc_usd_data.csv"
)
